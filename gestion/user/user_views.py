...
from gestion.user.user_service import UserService
...
def password_reset_request(request):
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'user/password_reset_request.html', {'error': 'Correo no registrado.'})
...
def password_reset(request, uidb64, token):
    ...
    return render(request, 'user/password_reset_form.html', {'uidb64': uidb64, 'token': token})